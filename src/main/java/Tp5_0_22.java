...
public class Tp5_0_22
{
    ...
    public boolean check(String targetUrl) throws Exception
    {
        ...
        Request request = new Request.Builder().url(fullUrl).addHeader("Connection", "close").build();
        ...
        if (targetUrl.indexOf("https") != -1)
        {
            ...
            okHttpClient2.newBuilder().connectTimeout(30, TimeUnit.SECONDS).readTimeout(30, TimeUnit.SECONDS).writeTimeout(30, TimeUnit.SECONDS).build();
            //https协议发送payload
